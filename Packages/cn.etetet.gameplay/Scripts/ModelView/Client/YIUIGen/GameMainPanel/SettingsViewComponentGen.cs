...
namespace ET.Client
{
    ...
    public partial class SettingsViewComponent : Entity, IDestroy, IAwake, IYIUIBind, IYIUIInitialize, IYIUIOpen
    {
        public const string PkgName = "GameMainPanel";
        public const string ResName = "SettingsView";
        ...
        public const string OnEventBackBtnClickInvoke = "SettingsViewComponent.OnEventBackBtnClickInvoke";
